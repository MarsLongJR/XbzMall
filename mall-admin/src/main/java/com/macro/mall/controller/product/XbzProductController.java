...
public class XbzProductController {
    @Autowired
    private XbzProductService productService;
    ...
    @ResponseBody
    public Object create(@RequestBody XbzProductParam productParam, BindingResult bindingResult) {
    ...
    public Object getUpdateInfo(@PathVariable Long id) {
        XbzProductResult productResult = productService.getUpdateInfo(id);
    ...
    @ResponseBody
    public Object update(@PathVariable Long id, @RequestBody XbzProductParam productParam, BindingResult bindingResult) {
    ...
    @ResponseBody
    public Object getList(XbzProductQueryParam productQueryParam,
                          @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                          @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        List<XbzProduct> productList = productService.list(productQueryParam, pageSize, pageNum);
    ...
    public Object getList(String  keyword) {
        List<XbzProduct> productList = productService.list(keyword);
